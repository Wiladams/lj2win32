...
--]]
ffi.cdef[[
static const int ERROR_IMAGE_NOT_STRIPPED   = 0x8800;  // the image is not stripped.  No dbg file available.
static const int ERROR_NO_DBG_POINTER       = 0x8801;  // image is stripped but there is no pointer to a dbg file
static const int ERROR_NO_PDB_POINTER       = 0x8802;  // image does not point to a pdb file
]]
