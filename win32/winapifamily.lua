...
if not _INC_WINAPIFAMILY then
_INC_WINAPIFAMILY = true
...
if not WINAPI_PARTITION_PC_APP then
WINAPI_PARTITION_PC_APP  =                                              
  (WINAPI_FAMILY == WINAPI_FAMILY_DESKTOP_APP or                               
   WINAPI_FAMILY == WINAPI_FAMILY_PC_APP)
end 

if not WINAPI_PARTITION_PHONE_APP then
 ...
 */
--]]
if not WINAPI_PARTITION_SYSTEM then
 ...
 * 
 *     #if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP) and !WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP)
 *
 * or
 *
 *     #if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP) and !WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_PHONE_APP)
 *
 * Direct references to WINAPI_PARTITION_ values (eg #if !WINAPI_FAMILY_PARTITION_...)
 * should not be used.
 */ 
--]]
function WINAPI_FAMILY_PARTITION(...)     
    local nargs = select('#', ...)
...
#endif // WINAPIFAMILY_PARTITION(WINAPI_PARTITION_APP) and !WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP)
--]]


end  --/* !_INC_WINAPIFAMILY */
