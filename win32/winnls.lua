...
require("win32.datetimeapi")  -- Datetime APISET dependencies
require("win32.libloaderapi") -- LibLoader Apiset dependencies
end
...
//
static const int  CSTR_LESS_THAN           = 1;           // string 1 less than string 2
static const int  CSTR_EQUAL               = 2;           // string 1 equal to string 2
static const int  CSTR_GREATER_THAN        = 3;           // string 1 greater than string 2
...
if (WINVER >= _WIN32_WINNT_WIN8) then
ffi.cdef[[
//
...
if not GetDurationFormatEx_DEFINED then
ffi.cdef[[
int
__stdcall
GetDurationFormatEx(
...
if (WINVER >= _WIN32_WINNT_WIN7) then
