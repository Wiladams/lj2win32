...
if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP , WINAPI_PARTITION_TV_APP , WINAPI_PARTITION_TV_TITLE) then
--[[
...
// argument and the voices sample rate: the product of these numbers cannot exceed 600000
