...
#define HTTP_STATUS_AMBIGUOUS           300 // server couldnt decide what to return
...
#define ICU_NO_ENCODE   0x20000000  // Dont convert unsafe characters to escape sequence
#define ICU_DECODE      0x10000000  // Convert %XX escape sequences to characters
#define ICU_NO_META     0x08000000  // Dont convert .. etc. meta path sequences
