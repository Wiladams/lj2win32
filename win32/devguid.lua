--[[
    Windows classes are defined in the system file Devguid.h. 
    This file defines a series of GUIDs for setup classes. However, 
    the device setup classes represented in Devguid.h must not be 
    confused with device interface classes. The Devguid.h file only 
    contains GUIDs for setup classes.

    guiddef should have been required before this to pickup DEFINE_GUID
--]]
