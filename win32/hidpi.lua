...
ffi.cdef[[
static const int FACILITY_HID_ERROR_CODE = 0x11;
]]
--end
...
makeStatic("HIDP_STATUS_NULL",                     HIDP_ERROR_CODES(0x8,1))
makeStatic("HIDP_STATUS_INVALID_PREPARSED_DATA",   HIDP_ERROR_CODES(0xC,1))
makeStatic("HIDP_STATUS_INVALID_REPORT_TYPE",      HIDP_ERROR_CODES(0xC,2))
makeStatic("HIDP_STATUS_INVALID_REPORT_LENGTH",    HIDP_ERROR_CODES(0xC,3))
makeStatic("HIDP_STATUS_USAGE_NOT_FOUND",          HIDP_ERROR_CODES(0xC,4))
makeStatic("HIDP_STATUS_VALUE_OUT_OF_RANGE",       HIDP_ERROR_CODES(0xC,5))
makeStatic("HIDP_STATUS_BAD_LOG_PHY_VALUES",       HIDP_ERROR_CODES(0xC,6))
makeStatic("HIDP_STATUS_BUFFER_TOO_SMALL",         HIDP_ERROR_CODES(0xC,7))
makeStatic("HIDP_STATUS_INTERNAL_ERROR",           HIDP_ERROR_CODES(0xC,8))
makeStatic("HIDP_STATUS_I8042_TRANS_UNKNOWN",      HIDP_ERROR_CODES(0xC,9))
makeStatic("HIDP_STATUS_INCOMPATIBLE_REPORT_ID",   HIDP_ERROR_CODES(0xC,0xA))
makeStatic("HIDP_STATUS_NOT_VALUE_ARRAY",          HIDP_ERROR_CODES(0xC,0xB))
makeStatic("HIDP_STATUS_IS_VALUE_ARRAY",           HIDP_ERROR_CODES(0xC,0xC))
makeStatic("HIDP_STATUS_DATA_INDEX_NOT_FOUND",     HIDP_ERROR_CODES(0xC,0xD))
makeStatic("HIDP_STATUS_DATA_INDEX_OUT_OF_RANGE",  HIDP_ERROR_CODES(0xC,0xE))
makeStatic("HIDP_STATUS_BUTTON_NOT_PRESSED",       HIDP_ERROR_CODES(0xC,0xF))
makeStatic("HIDP_STATUS_REPORT_DOES_NOT_EXIST",    HIDP_ERROR_CODES(0xC,0x10))
makeStatic("HIDP_STATUS_NOT_IMPLEMENTED",          HIDP_ERROR_CODES(0xC,0x20))
