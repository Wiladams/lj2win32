...
enum DWRITE_GLYPH_IMAGE_FORMATS
{
    ...
    /// </summary>
    /// <remarks>
    /// Fonts may store the content gzipd rather than plain text,
...
if DEFINE_ENUM_FLAG_OPERATORS then
DEFINE_ENUM_FLAG_OPERATORS = function(imageFormat) return end
end
