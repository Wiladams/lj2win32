...
if __REQUIRED_RPCNDR_H_VERSION__ then
    if ( __RPCNDR_H_VERSION__ < __REQUIRED_RPCNDR_H_VERSION__ ) then
        error ("incorrect <rpcndr> version. Use the header that matches with the MIDL compiler.")
    end
end
...
ffi.cdef[[
static const int NDR_CHAR_REP_MASK            =   0X0000000F;
static const int NDR_INT_REP_MASK             =   0X000000F0;
static const int NDR_FLOAT_REP_MASK           =   0X0000FF00;

static const int NDR_LITTLE_ENDIAN            =   0X00000010;
static const int NDR_BIG_ENDIAN               =   0X00000000;

static const int NDR_IEEE_FLOAT               =   0X00000000;
static const int NDR_VAX_FLOAT                =   0X00000100;
static const int NDR_IBM_FLOAT                =   0X00000300;

static const int NDR_ASCII_CHAR               =   0X00000000;
static const int NDR_EBCDIC_CHAR              =   0X00000001;
...
if not _WCHAR_T_DEFINED then
_WCHAR_T_DEFINED = true;
ffi.cdef[[
