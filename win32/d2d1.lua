...
typedef enum D2D1_GEOMETRY_RELATION
{
    ...
    /// <summary>
    /// The relation between the geometries couldnt be determined. This value is never
...
interface DX_DECLARE_INTERFACE("2cd906a7-12e2-11dc-9fed-001143a055f9") ID2D1GradientStopCollection  : public ID2D1Resource
{
    ...
    /// <summary>
    /// Copies the gradient stops from the collection into the callers interface.  The
...
/// <summary>
/// The root factory interface for all of D2Ds objects.
/// </summary>
...
ffi.cdef[[
    //
    // This export cannot be in a namespace because compiler name mangling isnt consistent
...
-- no need to include for now as it is inline C++ classes
--require("win32.d2d1helper")
