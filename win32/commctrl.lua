...
ffi.cdef[[
static const int ICC_LISTVIEW_CLASSES   = 0x00000001; // listview, header
static const int ICC_TREEVIEW_CLASSES   = 0x00000002; // treeview, tooltips
static const int ICC_BAR_CLASSES        = 0x00000004; // toolbar, statusbar, trackbar, tooltips
static const int ICC_TAB_CLASSES        = 0x00000008; // tab, tooltips
static const int ICC_UPDOWN_CLASS       = 0x00000010; // updown
static const int ICC_PROGRESS_CLASS     = 0x00000020; // progress
static const int ICC_HOTKEY_CLASS       = 0x00000040; // hotkey
static const int ICC_ANIMATE_CLASS      = 0x00000080; // animate
static const int ICC_WIN95_CLASSES      = 0x000000FF;
static const int ICC_DATE_CLASSES       = 0x00000100; // month picker, date picker, time picker, updown
static const int ICC_USEREX_CLASSES     = 0x00000200; // comboex
static const int ICC_COOL_CLASSES       = 0x00000400; // rebar (coolbar) control
static const int ICC_INTERNET_CLASSES   = 0x00000800;
static const int ICC_PAGESCROLLER_CLASS = 0x00001000;   // page scroller
static const int ICC_NATIVEFNTCTL_CLASS = 0x00002000;   // native font control
static const int ICC_STANDARD_CLASSES   = 0x00004000;
static const int ICC_LINK_CLASS         = 0x00008000;
]]
...
ffi.cdef[[
static const int ODT_HEADER             = 100;
static const int ODT_TAB                = 101;
static const int ODT_LISTVIEW           = 102;
]]

ffi.cdef[[
//====== Ranges for control message IDs =======================================

static const int LVM_FIRST               = 0x1000;      // ListView messages
static const int TV_FIRST                = 0x1100;      // TreeView messages
static const int HDM_FIRST               = 0x1200;      // Header messages
static const int TCM_FIRST               = 0x1300;      // Tab control messages

static const int PGM_FIRST               = 0x1400;      // Pager control messages


static const int ECM_FIRST               = 0x1500;      // Edit control messages
static const int BCM_FIRST               = 0x1600;      // Button control messages
static const int CBM_FIRST               = 0x1700;      // Combobox control messages


static const int CCM_FIRST               = 0x2000;      // Common control shared messages
static const int CCM_LAST                =(CCM_FIRST + 0x200);


static const int CCM_SETBKCOLOR          =(CCM_FIRST + 1); // lParam is bkColor
]]
...
#define ILC_HIGHQUALITYSCALE    0x00020000      // Imagelist should enable use of the high quality scaler.
 ...
 BOOL        __stdcall ImageList_Destroy(_In_opt_ HIMAGELIST himl);
 ...
 int         __stdcall ImageList_Add(HIMAGELIST himl, HBITMAP hbmImage, _In_opt_ HBITMAP hbmMask);
...
#define HBITMAP_CALLBACK               ((HBITMAP)-1)       // only for SparseImageList
 ...
 BOOL        __stdcall ImageList_Replace(HIMAGELIST himl, int i, HBITMAP hbmImage, _In_opt_ HBITMAP hbmMask);
...
#define ILP_DOWNLEVEL       1           // Write or reads the stream using downlevel sematics.
 ...
 HRESULT __stdcall ImageList_ReadEx(DWORD dwFlags, struct IStream *pstm, REFIID riid, _Outptr_ PVOID* ppv);
 HRESULT __stdcall ImageList_WriteEx(HIMAGELIST himl, DWORD dwFlags, struct IStream *pstm);
#endif
...
#if (NTDDI_VERSION >= NTDDI_WINXP)
 HRESULT __stdcall HIMAGELIST_QueryInterface(HIMAGELIST himl, REFIID riid, _Outptr_ void **ppv);
...
//====== MENU HELP ============================================================
 ...
 void __stdcall MenuHelp(UINT uMsg, WPARAM wParam, LPARAM lParam, HMENU hMainMenu, HINSTANCE hInst, HWND hwndStatus, _In_reads_(_Inexpressible_(2 + 2n && n >= 1)) UINT *lpwIDs);
 BOOL __stdcall ShowHideMenuCtl(HWND hWnd, UINT_PTR uFlags, _In_z_ LPINT lpInfo);
 void __stdcall GetEffectiveClientRect(HWND hWnd, LPRECT lprc,  _In_z_ const INT *lpInfo);
...
#define UDM_GETPOS32            (WM_USER+114)
 ...
 HWND __stdcall CreateUpDownControl(DWORD dwStyle, int x, int y, int cx, int cy,
...
ffi.cdef[[
//====== Flat Scrollbar APIs=========================================
static const int WSB_PROP_CYVSCROLL = 0x00000001L;
static const int WSB_PROP_CXHSCROLL = 0x00000002L;
static const int WSB_PROP_CYHSCROLL = 0x00000004L;
static const int WSB_PROP_CXVSCROLL = 0x00000008L;
static const int WSB_PROP_CXHTHUMB  = 0x00000010L;
static const int WSB_PROP_CYVTHUMB  = 0x00000020L;
static const int WSB_PROP_VBKGCOLOR = 0x00000040L;
static const int WSB_PROP_HBKGCOLOR = 0x00000080L;
static const int WSB_PROP_VSTYLE    = 0x00000100L;
static const int WSB_PROP_HSTYLE    = 0x00000200L;
static const int WSB_PROP_WINSTYLE  = 0x00000400L;
static const int WSB_PROP_PALETTE   = 0x00000800L;
static const int WSB_PROP_MASK      = 0x00000FFFL;

static const int FSB_FLAT_MODE          = 2;
static const int FSB_ENCARTA_MODE       = 1;
static const int FSB_REGULAR_MODE       = 0;
]]
...
ffi.cdef[[
 ...
 --[[
#ifdef _WIN64
 BOOL __stdcall FlatSB_GetScrollPropPtr(HWND, int propIndex, PINT_PTR);
#else
...
enum _LI_METRIC
{
 ...
 HRESULT __stdcall LoadIconWithScaleDown(HINSTANCE hinst, PCWSTR pszName, int cx, int cy, HICON *phico);



int __stdcall DrawShadowText(HDC hdc, 
    LPCWSTR pszText, UINT cch, 
    RECT* prc, 
    DWORD dwFlags, 
    COLORREF crText, 
    COLORREF crShadow,
