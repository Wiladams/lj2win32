...
if not OUR_GUID_ENTRY then
OUR_GUID_ENTRY = DEFINE_GUID
--[[
...
function MEDIASUBTYPE_HASALPHA(mt) return ( (mt.subtype == MEDIASUBTYPE_ARGB4444)            or 
                                    (mt.subtype == MEDIASUBTYPE_ARGB32)              or 
                                    (mt.subtype == MEDIASUBTYPE_AYUV)                or 
                                    (mt.subtype == MEDIASUBTYPE_AI44)                or 
                                    (mt.subtype == MEDIASUBTYPE_IA44)                or 
                                    (mt.subtype == MEDIASUBTYPE_ARGB1555)            or 
                                    (mt.subtype == MEDIASUBTYPE_ARGB32_D3D_DX7_RT)   or 
                                    (mt.subtype == MEDIASUBTYPE_ARGB4444_D3D_DX7_RT) or 
                                    (mt.subtype == MEDIASUBTYPE_ARGB1555_D3D_DX7_RT) or 
                                    (mt.subtype == MEDIASUBTYPE_ARGB32_D3D_DX9_RT)   or 
                                    (mt.subtype == MEDIASUBTYPE_ARGB4444_D3D_DX9_RT) or 
                                    (mt.subtype == MEDIASUBTYPE_ARGB1555_D3D_DX9_RT) )
end

function MEDIASUBTYPE_HASALPHA7(mt) return ((mt.subtype == MEDIASUBTYPE_ARGB32_D3D_DX7_RT)   or 
                                    (mt.subtype == MEDIASUBTYPE_ARGB4444_D3D_DX7_RT) or 
                                    (mt.subtype == MEDIASUBTYPE_ARGB1555_D3D_DX7_RT) )
end

function MEDIASUBTYPE_D3D_DX7_RT(mt) return ((mt.subtype == MEDIASUBTYPE_ARGB32_D3D_DX7_RT)   or 
                                     (mt.subtype == MEDIASUBTYPE_ARGB4444_D3D_DX7_RT) or 
                                     (mt.subtype == MEDIASUBTYPE_ARGB1555_D3D_DX7_RT) or 
                                     (mt.subtype == MEDIASUBTYPE_RGB32_D3D_DX7_RT)    or 
                                     (mt.subtype == MEDIASUBTYPE_RGB16_D3D_DX7_RT))
end

function MEDIASUBTYPE_HASALPHA9(mt) return ((mt.subtype == MEDIASUBTYPE_ARGB32_D3D_DX9_RT)   or 
                                    (mt.subtype == MEDIASUBTYPE_ARGB4444_D3D_DX9_RT) or 
                                    (mt.subtype == MEDIASUBTYPE_ARGB1555_D3D_DX9_RT) )
end

function MEDIASUBTYPE_D3D_DX9_RT(mt) return ((mt.subtype == MEDIASUBTYPE_ARGB32_D3D_DX9_RT)   or 
                                     (mt.subtype == MEDIASUBTYPE_ARGB4444_D3D_DX9_RT) or 
                                     (mt.subtype == MEDIASUBTYPE_ARGB1555_D3D_DX9_RT) or 
                                     (mt.subtype == MEDIASUBTYPE_RGB32_D3D_DX9_RT)    or 
...
--
--      if not  __SOMETHING_DEFINED__
--      #define __SOMETHING_DEFINED__
--          all the header contents
--      end  -- __SOMETHING_DEFINED__
--
...
if not  __ENCODER_API_GUIDS__ then
__ENCODER_API_GUIDS__ = true
