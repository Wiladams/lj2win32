...
function drawGrid()
    ...
    stroke(0,0xff, 0xff)
    for column=1,8 do
        line(column*cellWidth, 0, column*cellWidth, height)
    end
    ...
    stroke(0xff,0, 0)
    for column=1,2 do
        line(column*cellWidth*3, 0, column*cellWidth*3, height)
    end
    
    for row=1,2 do
        line(0,row*cellHeight*3, width, row*cellHeight*3)
    end
end
...
go({width=900, height=900, title="Sudoku"});
