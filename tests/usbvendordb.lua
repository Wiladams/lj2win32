return {
	...
	[0x041e] = { 
		...
		products = {
			...
			[0x4097] = "Live! Cam Chat HD [VF0700]",
	...
	[0x045e] = { 
		...
		products = {
			...
			[0x07c6] = "RTL8153 GigE [Surface Dock Ethernet]",
			...
			[0x0a00] = "Lumia 950 Dual SIM (RM-1118)",
	...
	[0x04f9] = { 
		...
		products = {
			...
			[0x2028] = "QL-570 P-touch Label Printer",
	...
	[0x0525] = { 
		...
		products = {
			...
			[0xa4a5] = "Pocketbook Pro 903 / Mobius 2 Action Cam",
	...
	[0x056a] = { 
		...
		products = {
			...
			[0x032f] = "DTU-1031X",
			[0x0347] = "Integrated Hub",
			[0x0348] = "Integrated Hub",
	...
	[0x0951] = { 
		...
		products = {
			...
			[0x1666] = "DataTraveler 100 G3/G4/SE9 G2",
	...
	[0x0bdb] = { 
		...
		products = {
			...
			[0x1926] = "H5321 gw Mobile Broadband Driver",
		}
	},
	[0x0bdc] = { 
		name = "Y Media Corp.",
	...
	[0x0cad] = { 
		...
		products = {
			...
			[0x9001] = "PowerPad Pocket PCÂ Device",
		}
	},
	[0x0cae] = { 
	...
	[0x1004] = { 
		...
		products = {
			...
			[0x633e] = "G2/G3 Android Phone [MTP/PTP/Download mode]",
	...
	[0x1058] = { 
		...
		products = {
			...
			[0x25a1] = "Elements / My Passport (WD20NMVW)",
	...
	[0x10c4] = { 
		...
		products = {
			...
			[0xea60] = "CP2102/CP2109 UART Bridge Controller [CP210x family]",
	...
	[0x12d1] = { 
		...
		products = {
			...
			[0x14db] = "E353/E3131",
			[0x14dc] = "E33372 LTE/UMTS/GSM HiLink Modem/Networkcard",
	...
	[0x152d] = { 
		...
		products = {
			...
			[0x0578] = "JMS567 SATA 6Gb/s bridge",
	...
	[0x1532] = { 
		...
		products = {
			...
			[0x0118] = "RZ03-0080, Gaming Keyboard [Deathstalker]",
	...
	[0x174c] = { 
		...
		products = {
			...
			[0x55aa] = "Name: ASM1051E SATA 6Gb/s bridge, ASM1053E SATA 6Gb/s bridge, ASM1153 SATA 3Gb/s bridge, ASM1153E SATA 6Gb/s bridge",
		}
	},
	[0x174f] = { 
		name = "Syntek",
	...
	[0x18d1] = { 
		...
		products = {
			...
			[0x4ee0] = "Nexus 4 (bootloader)",
			[0x4ee1] = "Nexus Device (MTP)",
			[0x4ee2] = "Nexus Device (debug)",
			[0x4ee3] = "Nexus 4/5/7/10 (tether)",
			[0x4ee4] = "Nexus 4/5/7/10 (debug + tether)",
			[0x4ee5] = "Nexus 4 (PTP)",
			[0x4ee6] = "Nexus 4/5 (PTP + debug)",
	...
	[0x1d50] = { 
		...
		products = {
			...
			[0x60ec] = "Duet 3D Printer Controller",
			[0x60f0] = "UDAD-T1 data aquisition device (boot)",
			[0x60f1] = "UDAD-T1 data aquisition device",
			[0x60f2] = "UDAD-T2 data aquisition device (boot)",
			[0x60f3] = "UDAD-T2 data aquisition device",
			...
			[0x610d] = "Magic Keys",
			[0x8085] = "Box0 (box0-v5)",
			[0xcc15] = "rad1o badge for CCC congress 2015",
		}
	},
	[0x1d57] = { 
		name = "Xenta",
	...
	[0x2357] = { 
		...
		products = {
			...
			[0x0107] = "TL-WN821N Version 5 RTL8192EU",
			[0x0108] = "TL-WN822N Version 4 RTL8192EU",
			[0x0109] = "TL WN823N RTL8192EU",
			[0x010c] = "TL-WN722N v2",
			[0x010e] = "TL-WN722N v2",
	...
	[0x2b24] = { 
		name = "KeepKey LLC",
		products = {
			[0x0001] = "Bitcoin hardware wallet",
		}
	},
	[0x2c02] = { 
		name = "Planex Communications",
